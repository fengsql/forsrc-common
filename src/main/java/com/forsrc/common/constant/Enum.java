...
public class Enum {
  ...
  public enum DataTypeDb {
    ...
    char_(6, "char"),
    date_(7, "date"),
    datetime_(8, "datetime"),
    decimal_(9, "decimal"),
    double_(10, "double"),
    enum_(11, "enum"),
    float_(12, "float"),
    geometry_(13, "geometry"),
    geometrycollection_(14, "geometrycollection"),
    int_(15, "int"),
    integer_(16, "integer"),
    json_(17, "json"),
    linestring_(18, "linestring"),
    longblob_(19, "longblob"),
    longtext_(20, "longtext"),
    mediumblob_(21, "mediumblob"),
    mediumint_(22, "mediumint"),
    mediumtext_(23, "mediumtext"),
    multilinestring_(24, "multilinestring"),
    multipoint_(25, "multipoint"),
    multipolygon_(26, "multipolygon"),
    numeric_(27, "numeric"),
    point_(28, "point"),
    polygon_(29, "polygon"),
    real_(30, "real"),
    set_(31, "set"),
    smallint_(32, "smallint"),
    text_(33, "text"),
    time_(34, "time"),
    timestamp_(35, "timestamp"),
    tinyblob_(36, "tinyblob"),
    tinyint_(37, "tinyint"),
    tinytext_(38, "tinytext"),
    varbinary_(39, "varbinary"),
    varchar_(40, "varchar"),
    nvarchar_(41, "nvarchar"),
    year_(42, "year"),
    ;
