...
public class DruidConfigure {
  ...
  public ServletRegistrationBean statViewServlet() {
    ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(new StatViewServlet(), "/local/druid/*");
    //IP白名单
  ...
  public FilterRegistrationBean statFilter() {
    ...
    //添加过滤规则
    filterRegistrationBean.addInitParameter("exclusions", "*.js,*.gif,*.jpg,*.png,*.css,*.ico,/local/druid/*");
